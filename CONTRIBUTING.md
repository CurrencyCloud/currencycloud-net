...
```Shell
	git clone git@github.com:your-username/currencycloud-net.git
```
...
[MIT]: LICENSE.md
[iss]: https://github.com/CurrencyCloud/currencycloud-net/issues
[pr]: https://github.com/CurrencyCloud/currencycloud-net/compare
[hof]: HALL_OF_FAME.md